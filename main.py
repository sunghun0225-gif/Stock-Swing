...
def export_as_image(df, title, meta_text=""):
    ...
    fp_normal = fm.FontProperties(fname=FONT_PATH, size=10)
    fp_title  = fm.FontProperties(fname=FONT_PATH, size=15)
    fp_meta   = fm.FontProperties(fname=FONT_PATH, size=9)
    fp_header = fm.FontProperties(fname=FONT_PATH, size=9)
    ...
    ax.text(0.5, 0.97, title, transform=ax.transAxes,
            ...
            fontproperties=fm.FontProperties(fname=FONT_PATH, size=15, weight="bold"))
    if meta_text:
        ax.text(0.5, 0.90, meta_text, transform=ax.transAxes,
                color="#8b949e", ha="center", va="top",
                fontproperties=fp_meta)
